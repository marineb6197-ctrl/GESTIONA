const CACHE='gestiona-v5-0';
const ASSETS=['./','./index.html','./manifest.webmanifest','./supabase-config.js','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
